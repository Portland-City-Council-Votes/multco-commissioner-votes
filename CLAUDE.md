...
- **Joint appointments without minutes:** SD 24 (Jan 6, 2021), HD 33 (Sept 26, 2024) and HD 48 (Nov 5, 2025) have no Multnomah minutes; they're logged with record `other source` from the County's news releases (SD 24, HD 33) and the Oregon Capital Chronicle's report (HD 48). **Gap:** SD 26 (Oct 23, 2025) stays `pending`: reports give only the overall count, not each Multnomah commissioner's vote.
